...
mod tests {
    ...
    fn fixed_encap_key() {
        ...
        let ek_encoded = Encoded::<ml_kem::kem::EncapsulationKey<ml_kem::MlKem512Params>>::try_from(&ek_bytes[..])
            .expect("failed to build hybrid array");
        let ek_decoded_in = ml_kem::kem::EncapsulationKey::<ml_kem::MlKem512Params>::from_bytes(&ek_encoded);

        let (rho, ntt) = byte_decode::<MlKem512>(&ek_bytes);

        let bytes_out = byte_encode::<MlKem512>(&rho, &ntt);

        let ek_encoded = Encoded::<ml_kem::kem::EncapsulationKey<ml_kem::MlKem512Params>>::try_from(&bytes_out[..])
            .expect("failed to build hybrid array");
        let ek_decoded_out = ml_kem::kem::EncapsulationKey::<ml_kem::MlKem512Params>::from_bytes(&ek_encoded);
