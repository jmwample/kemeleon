...
/// Trait for encoding Ciphertexts
pub trait Encode {
...
pub trait OKemCore: Clone {
    ...
    type Ciphertext: Debug + Encode<EncodedSize = Self::CiphertextSize> + PartialEq;
    ...
    /// The size of a Kemeleon encoded encapsulation key
    ...
    type EncapsulationKey: Encapsulate<Self::Ciphertext, Self::SharedKey>
        + Encode<EncodedSize = Self::EncapsulationKeySize>
        + PartialEq
        + Clone;
